...
class PauseSubState extends MusicBeatSubstate
{
	...
	public static var isOffsetTesting:Bool = false;
	...
	public function new(x:Float, y:Float)
	{
		...
		if (isOffsetTesting)
			{
				menuItems = ['Resume', 'Restart Song', 'Exit Offset Testing'];
			}
					...
					if (!isOffsetTesting)
						{
							...
							menuItems = ['Restart Song', 'Exit Offset Testing'];
						}
		...
		if (accepted)
		{
			...
			switch (daSelected)
			{
				...
				case "Restart Song":
					FlxG.resetState();
				case "Options":
					OptionsMenu.fromPauseState = true;
				...
				case "Exit Offset Testing":
					PlayState.offsetTesting = false;	
					isOffsetTesting = false;
					FlxG.switchState(new MainMenuState());
			}
		}
