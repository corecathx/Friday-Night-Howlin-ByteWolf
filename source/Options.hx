...
/*class ScreenShake extends Option
{
	public function new(desc:String)
	{
		super();
	...
	private override function updateDisplay():String
	{
		return "Screen Shake " + (FlxG.save.data.screenshake ? "" : "off");
	}
}*/
...
/*class LanguageOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return "Language: " + (FlxG.save.data.language ? "Indonesian" : "English");
	}
}*/

class AboutModEE extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.switchState(new AboutStateMod());
		trace("About menu selected.");
		return false;
	}
...
class FullScreenMode extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.fullmodescreen = !FlxG.save.data.fullmodescreen;
	...
	private override function updateDisplay():String
	{
		return "Fullscreen " + (FlxG.save.data.fullmodescreen ? "On" : "Off");
	}
}

class AnimDebugModeByte extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.animdebugsave = !FlxG.save.data.animdebugsave;
		trace("Animation Debug Enabled.");
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Debug Mode " + (FlxG.save.data.animdebugsave ? "On" : "Off");
	}
}

class MainMenuCharacters extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.menucharacter = !FlxG.save.data.menucharacter;
		trace("Woof?");
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "main menu characters: " + (FlxG.save.data.menucharacter ? "On" : "Off");
	}
}
...
class NoteSplashes extends Option
{
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.notesplash ? "Enable note splash" : "disable note splash";
	}
}

class RatingSpriteScale extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.switchState(new ResizeState());
		trace("le chum bucket");
		return false;
	}

	private override function updateDisplay():String
	{
		return "Change rating sprite size";
	}
}
class AchievementThing extends Option
{
	public function new(desc:String)
	{
		super();
